        ...
        <div className="flex flex-col gap-3">
          {projects.map((project) => (
            <Link key={project.slug} href={`/projects/${project.slug}`}>
              <div className="block rounded-lg border border-zinc-200 p-4 hover:border-zinc-400 transition-colors">
                ...
                {/* TODO: square images for project cards */}
                {/* <div className="bg-gray-100 w-24 h-24">Image</div> */}
              </div>
            </Link>
          ))}
        </div>
